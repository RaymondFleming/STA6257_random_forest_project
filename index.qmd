...
printTable=matrix(c(round(cm$overall['Accuracy'],2),
                    ...
                    if(cm$overall['McnemarPValue']<0.001){"<.001"}
                    else round(cm$overall['McnemarPValue'],3)),
                    ncol=1,
                    byrow=TRUE)
colnames(printTable)=c('Score')
rownames(printTable)=c('Accuracy','Kappa','95% CI','AccuracyNull','Accuracy p-value','Mcnemar\'s p-value')
